...
organization_config = {
  org_id          = "252632484771" # REQUIRED EDIT Numeric portion only '#############'"
  ...
  owner           = "Ks" # REQUIRED EDIT Used in naming standard
  ...
  #root_node       = "organizations/252632484771" # REQUIRED EDIT format "organizations/#############" or "folders/#############"
  root_node       = "folders/1096166437458" # REQUIRED EDIT format "organizations/#############" or "folders/#############"
  
  contacts = {
    "udaykakkar@kubeshot.com" = ["ALL"] # REQUIRED EDIT Essential Contacts for notifications. Must be in the form EMAIL -> [NOTIFICATION_TYPES]
  }
  billing_account = "01F01C-EC0BAC-DD9482" # REQUIRED EDIT Format of ######-######-######
}
